...
public class EaseMessageAdapter extends BaseAdapter {
	...
	protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
		...
		Member emp = DBHelper.getInstance(context).getMemberId(message.getFrom());
		if(emp != null){
			imageLoader.displayImage(emp.getEmpCover(), chatRow.userAvatarView, CaopingCloudApplication.txOptions, animateFirstListener);
...
//									imageLoader.displayImage(empInfo.getMm_emp_cover(), view , CaopingCloudApplication.txOptions);
//								}
//
//							} else {
//
