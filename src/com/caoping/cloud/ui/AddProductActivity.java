...
//    AsyncHttpClient client = new AsyncHttpClient();
    ...
    private void initView() {
        ...
        this.findViewById(R.id.liner_type_one).setOnClickListener(this);
        ...
        typeOne = (TextView) this.findViewById(R.id.typeOne);
        typeTwo = (TextView) this.findViewById(R.id.typeTwo);
        guige.setText("选择规格");
        typeOne.setText("选择属性");
        ...
        gridView1.setOnItemClickListener(new GridView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (path.indexOf("camera_default") != -1) {
                    ...
                    Intent intent = new Intent(AddProductActivity.this, ImageDelActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_gg: {
                //规格
                Intent intent = new Intent(AddProductActivity.this, SelectCpGuigeActivity.class);
                startActivityForResult(intent, 1000);
            }
            break;
            case R.id.liner_type_one: {
                //草坪属性
                Intent intent = new Intent(AddProductActivity.this, SelectCpTypeActivity.class);
                startActivityForResult(intent, 1000);
            }
            break;
            case R.id.liner_type_two: {
                //草坪用途
                Intent intent = new Intent(AddProductActivity.this, SelectCpUseActivity.class);
                startActivityForResult(intent, 1000);
            }
            break;
            case R.id.address: {
            ...
            case R.id.right_btn:
            {
                ...
                if(StringUtil.isNullOrEmpty(name.getText().toString())){
                    showMsg(AddProductActivity.this, "请输入标题！");
                    return;
                }
                if(name.getText().toString().length() > 100){
                    showMsg(AddProductActivity.this, "标题超出字段限制，100字以内！");
                    return;
                }
                if(StringUtil.isNullOrEmpty(content.getText().toString())){
                    showMsg(AddProductActivity.this, "请输入内容！");
                    return;
                }
                if(content.getText().toString().length() > 1000){
                    showMsg(AddProductActivity.this, "内容超出字段限制，1000字以内！");
                    return;
                }
                if(dataList.size() == 1){
                    showMsg(AddProductActivity.this, "请至少选择一张图片！");
                    return;
                }
                if(StringUtil.isNullOrEmpty(cloud_caoping_guige_id)){
                    showMsg(AddProductActivity.this, "请选择规格！");
                    return;
                }
                if(StringUtil.isNullOrEmpty(money.getText().toString())){
                    showMsg(AddProductActivity.this, "请输入价格！");
                    return;
                }
                if(StringUtil.isNullOrEmpty(cloud_caoping_type_id)){
                    showMsg(AddProductActivity.this, "请选择属性！");
                    return;
                }
                if(StringUtil.isNullOrEmpty(cloud_caoping_use_id)){
                    showMsg(AddProductActivity.this, "请选择用途！");
                    return;
                }
        ...
        StringRequest request = new StringRequest(
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                String code = jo.getString("code");
                                if (code.equals("200")) {
                                    Toast.makeText(AddProductActivity.this, R.string.publish_success, Toast.LENGTH_SHORT).show();
                                    //调用广播，刷新主页
                                    Intent intent1 = new Intent("add_product_success");
                                    sendBroadcast(intent1);
                                    finish();
                                }else{
                                    showMsg(AddProductActivity.this, jo.getString("message"));
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(AddProductActivity.this, R.string.publish_error_one, Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("cloud_caoping_guige_id", cloud_caoping_guige_id);
                params.put("cloud_caoping_type_id", cloud_caoping_type_id);
    ...
    private void showSelectImageDialog() {
        deleteWindow = new SelectPhoPopWindow(AddProductActivity.this, itemsOnClick);
        //显示窗口
        deleteWindow.showAtLocation(AddProductActivity.this.findViewById(R.id.main), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
    }
...
//                        }
        ...
        if(requestCode == 1000){
            ...
            switch (resultCode) {
                ...
                case 1002:
                {
                    cloud_caoping_type_id = data.getStringExtra("cloud_caoping_type_id");
                    String cloud_caoping_type_cont = data.getStringExtra("cloud_caoping_type_cont");
                    if(!StringUtil.isNullOrEmpty(cloud_caoping_type_cont)){
                        typeOne.setText(cloud_caoping_type_cont);
                    }
                }
                break;
                case 1003:
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.mapstorage: {
                    Intent intent = new Intent(AddProductActivity.this, AlbumActivity.class);
    ...
    private void showSelectPublishDialog() {
        publishPopWindow = new PublishPopWindow(AddProductActivity.this, itemOnClick);
        publishPopWindow.showAtLocation(AddProductActivity.this.findViewById(R.id.main), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
    }
