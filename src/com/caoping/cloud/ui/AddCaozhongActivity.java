 ...
 */
public class AddCaozhongActivity extends BaseActivity implements View.OnClickListener{
...
//    AsyncHttpClient client = new AsyncHttpClient();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_caozhong_activity);
        ...
        gridView1.setOnItemClickListener(new GridView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (path.indexOf("camera_default") != -1) {
                    ...
                    Intent intent = new Intent(AddCaozhongActivity.this, ImageDelActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            {
                //规格
                Intent intent = new Intent(AddCaozhongActivity.this, SelectCaozhongGuigeActivity.class);
            ...
            {
                Intent intent = new Intent(AddCaozhongActivity.this, SelectCaozhongTypeActivity.class);
                startActivityForResult(intent, 1000);
            }
                break;
            case R.id.address:
            ...
            case R.id.right_btn:
            {
                ...
                if(StringUtil.isNullOrEmpty(name.getText().toString())){
                    showMsg(AddCaozhongActivity.this, "请输入标题！");
                    return;
                }
                if(name.getText().toString().length() > 100){
                    showMsg(AddCaozhongActivity.this, "标题超出字段限制，100字以内！");
                    return;
                }
                if(StringUtil.isNullOrEmpty(content.getText().toString())){
                    showMsg(AddCaozhongActivity.this, "请输入内容！");
                    return;
                }
                if(content.getText().toString().length() > 1000){
                    showMsg(AddCaozhongActivity.this, "内容超出字段限制，1000字以内！");
                    return;
                }
                if(dataList.size() == 1){
                ...
                if(StringUtil.isNullOrEmpty(cloud_caoping_guige_id)){
                    showMsg(AddCaozhongActivity.this, "请选择规格！");
                    return;
                }
                if(StringUtil.isNullOrEmpty(money.getText().toString())){
                    showMsg(AddCaozhongActivity.this, "请输入价格！");
                    return;
                }
        ...
        StringRequest request = new StringRequest(
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                String code = jo.getString("code");
                                if (code.equals("200")) {
                                    Toast.makeText(AddCaozhongActivity.this, R.string.publish_success, Toast.LENGTH_SHORT).show();
                                    //调用广播，刷新主页
                                    Intent intent1 = new Intent("add_product_success");
                                    sendBroadcast(intent1);
                                    finish();
                                }else{
                                    showMsg(AddCaozhongActivity.this, jo.getString("message"));
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(AddCaozhongActivity.this, R.string.publish_error_one, Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("cloud_caozhong_guige_id", cloud_caoping_guige_id);
    ...
    private void showSelectImageDialog() {
        deleteWindow = new SelectPhoPopWindow(AddCaozhongActivity.this, itemsOnClick);
        //显示窗口
        deleteWindow.showAtLocation(AddCaozhongActivity.this.findViewById(R.id.main), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
    }
...
//                        }
        ...
        if(requestCode == 1000){
            ...
            switch (resultCode) {
                ...
                case 1003:
                {
                    cloud_caozhong_type_id = data.getStringExtra("cloud_caoping_use_id");
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.mapstorage: {
                    Intent intent = new Intent(AddCaozhongActivity.this, AlbumActivity.class);
    ...
    private void showSelectPublishDialog() {
        publishPopWindow = new PublishPopWindow(AddCaozhongActivity.this, itemOnClick);
        publishPopWindow.showAtLocation(AddCaozhongActivity.this.findViewById(R.id.main), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
    }
