 ...
 * 物流 找货
 */
public class WuliuOneFragment extends BaseFragment  implements View.OnClickListener,OnClickContentItemListener {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.wuliu_one_fragment, null);
    ...
    private void initView() {
        ...
        adapter1 = new ItemWuliuHuoAdapter(lists1, getActivity());
        ...
        img_action.setOnClickListener(this);
    ...
    private void getData1() {
        StringRequest request = new StringRequest(
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("is_type", "1");//0车辆信息 1货源信息
                params.put("is_use", "0");
            ...
            case R.id.img_action:
            {
                try {
                    ...
                    if (!isMobileNet && !isWifiNet) {
                        ...
                        progressDialog.setIndeterminate(true);
                        progressDialog.show();
                        start_address.setText("发货地");
                        end_address.setText("收货地");
                        areaidStart = "";
                        areaidEnd = "";
                        getData1();
                    }
