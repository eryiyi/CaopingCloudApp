package com.caoping.cloud.huanxin.domain;
...
//        R.drawable.icon_040,
    ...
    private static EaseEmojiconGroupEntity createData(){
        ...
        for(int i = 0; i < icons.length; i++){
            ...
            datas[i].setName(CaopingCloudApplication.getInstance().getApplicationContext().getString(R.string.emojicon_test_name)+ (i+1));
