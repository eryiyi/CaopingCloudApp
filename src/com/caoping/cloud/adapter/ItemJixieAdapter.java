 ...
 * 机械
 */
public class ItemJixieAdapter extends BaseAdapter {
    ...
    public ItemJixieAdapter(List<CpObj> lists, Context mContect) {
        this.lists = lists;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContect).inflate(R.layout.item_jixie, null);
