 ...
 * 草种
 */
public class ItemCaozhongAdapter extends BaseAdapter {
    ...
    public ItemCaozhongAdapter(List<CpObj> lists, Context mContect) {
        this.lists = lists;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContect).inflate(R.layout.item_caozhong, null);
        ...
        if (cell != null) {
            ...
            if(!StringUtil.isNullOrEmpty(cell.getCloud_caoping_prices())){
                //说明有图片
